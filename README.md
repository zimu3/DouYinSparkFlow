...
GitHub 运行器曾能识别发送账号和打开目标页面，但这不等于私信已登录。[测试 #16](https://github.com/zimu3/DouYinSparkFlow/actions/runs/35318963907) 在发送方页面出现临时消息气泡后，重新打开私信触发登录面板；两端均未看到该测试消息。更新 Secret 后，[基础预检 #18](https://github.com/zimu3/DouYinSparkFlow/actions/runs/35320939535) 通过，但[实发 #19](https://github.com/zimu3/DouYinSparkFlow/actions/runs/35321129463) 在重新打开会话时找不到输入框，因此没有发送 C4。[双阶段无发送预检 #20](https://github.com/zimu3/DouYinSparkFlow/actions/runs/35321542608) 与 [#21](https://github.com/zimu3/DouYinSparkFlow/actions/runs/35321922596) 仍失败。当前云端自动发送未通过验证。其他旧的定时工作流保持禁用。
